...
public class LottieFontViewGroupP extends FrameLayout {
    private static final String TAG = "LottieFontViewGroup";
    private final List<View> views = new ArrayList<>();


    public LottieFontViewGroupP(Context context) {
        super(context);
        Log.d(TAG, "LottieFontViewGroup: hey m called context");
    //    init();
    }

    public LottieFontViewGroupP(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.d(TAG, "LottieFontViewGroup: hey m called context attr");
        init();
    }

    public LottieFontViewGroupP(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private  void init() {
        ...
        OnCompositionLoadedListener c = new OnCompositionLoadedListener() {
                    ...
                    public void onCompositionLoaded(LottieComposition composition) {
                        ...
                        cursorView.setLayoutParams(new LottieFontViewGroupP.LayoutParams(
        ...
        LottieComposition.Factory.fromAssetFileName(getContext(), "Mobilo/P.json", c);
    }
