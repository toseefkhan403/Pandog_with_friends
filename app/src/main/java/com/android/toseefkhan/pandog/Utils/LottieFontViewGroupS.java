...
public class LottieFontViewGroupS extends FrameLayout {
    ...
    public LottieFontViewGroupS(Context context) {
        super(context);
        Log.d(TAG, "LottieFontViewGroup: hey m called context");
    //    init();
    }

    public LottieFontViewGroupS(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.d(TAG, "LottieFontViewGroup: hey m called context attr");
        init();
    }

    public LottieFontViewGroupS(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private  void init() {
        ...
        LottieComposition.Factory.fromAssetFileName(getContext(), "Mobilo/S.json", c);
        LottieComposition.Factory.fromAssetFileName(getContext(), "Mobilo/S.json", c);
    }
