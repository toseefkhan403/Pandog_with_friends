...
public class LottieFontViewGroupU extends FrameLayout {
    ...
    public LottieFontViewGroupU(Context context) {
        super(context);
        Log.d(TAG, "LottieFontViewGroup: hey m called context");
    //    init();
    }

    public LottieFontViewGroupU(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.d(TAG, "LottieFontViewGroup: hey m called context attr");
        init();
    }

    public LottieFontViewGroupU(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private  void init() {
        ...
        LottieComposition.Factory.fromAssetFileName(getContext(), "Mobilo/U.json", c);
        LottieComposition.Factory.fromAssetFileName(getContext(), "Mobilo/U.json", c);
    }
