...
public class LottieFontViewGroupT extends FrameLayout {
    private static final String TAG = "LottieFontViewGroup";
    private final List<View> views = new ArrayList<>();


    public LottieFontViewGroupT(Context context) {
        super(context);
        Log.d(TAG, "LottieFontViewGroup: hey m called context");
    //    init();
    }

    public LottieFontViewGroupT(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.d(TAG, "LottieFontViewGroup: hey m called context attr");
        init();
    }

    public LottieFontViewGroupT(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private  void init() {
        ...
        LottieComposition.Factory.fromAssetFileName(getContext(), "Mobilo/T.json", c);
    }
