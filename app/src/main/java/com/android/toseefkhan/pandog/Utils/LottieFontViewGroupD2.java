...
public class LottieFontViewGroupD2 extends FrameLayout {
    private static final String TAG = "LottieFontViewGroup";
    private final List<View> views = new ArrayList<>();


    public LottieFontViewGroupD2(Context context) {
        super(context);
        Log.d(TAG, "LottieFontViewGroup: hey m called context");
    //    init();
    }

    public LottieFontViewGroupD2(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.d(TAG, "LottieFontViewGroup: hey m called context attr");
        init();
    }

    public LottieFontViewGroupD2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private  void init() {
        ...
        LottieComposition.Factory.fromAssetFileName(getContext(), "Mobilo/D.json", c);
    }
