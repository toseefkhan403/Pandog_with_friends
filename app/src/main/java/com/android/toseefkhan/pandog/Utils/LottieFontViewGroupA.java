...
public class LottieFontViewGroupA extends FrameLayout {
    ...
    public LottieFontViewGroupA(Context context) {
        super(context);
        Log.d(TAG, "LottieFontViewGroup: hey m called context");
    //    init();
    }

    public LottieFontViewGroupA(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.d(TAG, "LottieFontViewGroup: hey m called context attr");
        init();
    }

    public LottieFontViewGroupA(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private  void init() {
        ...
        LottieComposition.Factory.fromAssetFileName(getContext(), "Mobilo/A.json", c);
        LottieComposition.Factory.fromAssetFileName(getContext(), "Mobilo/A.json", c);
    }
