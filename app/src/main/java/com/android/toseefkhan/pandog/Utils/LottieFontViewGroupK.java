...
public class LottieFontViewGroupK extends FrameLayout {
    ...
    public LottieFontViewGroupK(Context context) {
        super(context);
        Log.d(TAG, "LottieFontViewGroup: hey m called context");
    //    init();
    }

    public LottieFontViewGroupK(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.d(TAG, "LottieFontViewGroup: hey m called context attr");
        init();
    }

    public LottieFontViewGroupK(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private  void init() {
        ...
        LottieComposition.Factory.fromAssetFileName(getContext(), "Mobilo/K.json", c);
        LottieComposition.Factory.fromAssetFileName(getContext(), "Mobilo/K.json", c);
    }
